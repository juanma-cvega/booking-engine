...
import com.jusoft.component.booking.BookingFixtures;
...
import com.jusoft.controller.booking.api.CreateBookingRequest;
...
import static com.jusoft.component.booking.BookingFixtures.BOOKINGS;
import static com.jusoft.component.booking.BookingFixtures.BOOKING_1;
...
import static com.jusoft.component.booking.BookingFixtures.BOOKING_RESOURCES;
import static com.jusoft.component.booking.BookingFixtures.BOOKING_RESOURCE_1;
import static com.jusoft.component.booking.BookingFixtures.CANCEL_BOOKING_COMMAND;
import static com.jusoft.component.booking.BookingFixtures.CREATE_BOOKING_COMMAND;
import static com.jusoft.component.booking.BookingFixtures.CREATE_BOOKING_REQUEST;
import static com.jusoft.component.slot.SlotFixtures.END_TIME;
import static com.jusoft.component.slot.SlotFixtures.SLOT_ID_1;
import static com.jusoft.component.slot.SlotFixtures.START_TIME;
import static com.jusoft.fixtures.CommonFixtures.ROOM_ID;
import static com.jusoft.fixtures.CommonFixtures.USER_ID_1;
import static com.jusoft.fixtures.CommonFixtures.USER_ID_2;
import static com.jusoft.util.HelpUtils.OBJECT_MAPPER;
...
public class BookingControllerRestTest {
  ...
  public void slotAlreadyStarted() throws Exception {
    when(mockBookingCommandFactory.createFrom(ROOM_ID, SLOT_ID_1, USER_ID_1)).thenReturn(CREATE_BOOKING_COMMAND);
    when(mockBookingComponent.book(CREATE_BOOKING_COMMAND)).thenThrow(new SlotAlreadyStartedException(SLOT_ID_1, ROOM_ID, ZonedDateTime.now()));
