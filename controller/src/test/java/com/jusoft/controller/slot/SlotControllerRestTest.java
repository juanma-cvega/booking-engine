...
import com.jusoft.component.slot.SlotFixtures;
...
public class SlotControllerRestTest {
    ...
    public void create() throws Exception {
        ...
        mockMvc.perform(post(SLOTS_URL).contentType(APPLICATION_JSON).content(objectMapper.writeValueAsString(CREATE_SLOT_REQUEST)))
                ...
                .andExpect(jsonPath("$.startDate", is(Long.valueOf(SlotFixtures.START_TIME).intValue())))
                .andExpect(jsonPath("$.endDate", is(Long.valueOf(SlotFixtures.END_TIME).intValue())));
    }
    ...
    public void getSlotsFor() throws Exception {
        ...
        mockMvc.perform(get(urlTemplate).contentType(APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.slots[0].startDate", is(Long.valueOf(SlotFixtures.START_TIME).intValue())))
                .andExpect(jsonPath("$.slots[0].endDate", is(Long.valueOf(SlotFixtures.END_TIME).intValue())))
                ...
                .andExpect(jsonPath("$.slots[1].startDate", is(Long.valueOf(SlotFixtures.START_TIME).intValue())))
                .andExpect(jsonPath("$.slots[1].endDate", is(Long.valueOf(SlotFixtures.END_TIME).intValue())));
    }

    @Test
    public void bookWithNullUserIdFails() throws Exception {
        CreateSlotRequest wrongSlotRequest = new CreateSlotRequest(null, SlotFixtures.START_TIME, SlotFixtures.END_TIME);
        mockMvc.perform(post(SLOTS_URL).contentType(APPLICATION_JSON).content(objectMapper.writeValueAsString(wrongSlotRequest)))
                .andExpect(status().isBadRequest());
    }

    @Test
    public void bookWithNullRoomIdFails() throws Exception {
        CreateSlotRequest wrongSlotRequest = new CreateSlotRequest(ROOM_ID, null, SlotFixtures.END_TIME);
        mockMvc.perform(post(SLOTS_URL).contentType(APPLICATION_JSON).content(objectMapper.writeValueAsString(wrongSlotRequest)))
                .andExpect(status().isBadRequest());
    }
    ...
    public void bookWithNullSlotIdFails() throws Exception {
        CreateSlotRequest wrongSlotRequest = new CreateSlotRequest(ROOM_ID, SlotFixtures.START_TIME, null);
        mockMvc.perform(post(SLOTS_URL).contentType(APPLICATION_JSON).content(objectMapper.writeValueAsString(wrongSlotRequest)))
                .andExpect(status().isBadRequest());
    }
