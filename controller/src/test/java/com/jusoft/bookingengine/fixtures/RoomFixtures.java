...
public class RoomFixtures {
  ...
  public static final OpenTime OPEN_TIME_MORNING = OpenTime.of(START_TIME_MORNING, END_TIME_MORNING, CLOCK.getZone(), CLOCK);
  ...
  public static final OpenTime OPEN_TIME_AFTERNOON = OpenTime.of(START_TIME_AFTERNOON, END_TIME_AFTERNOON, CLOCK.getZone(), CLOCK);
