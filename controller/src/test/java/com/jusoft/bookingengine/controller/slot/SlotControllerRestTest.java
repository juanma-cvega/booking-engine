...
import static com.jusoft.bookingengine.fixtures.SlotFixtures.END_DATE;
...
import static com.jusoft.bookingengine.fixtures.SlotFixtures.START_DATE;
...
class SlotControllerRestTest {
    ...
    void createSlot() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.startDate", is((int) getTimeFrom(START_DATE))))
                .andExpect(jsonPath("$.endDate", is((int) getTimeFrom(END_DATE))));
    }
