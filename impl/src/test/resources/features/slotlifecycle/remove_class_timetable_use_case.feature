Feature: As an admin, I want to remove a class timetable from a slot lifecycle manager of a room
  ...
  Scenario: As an admin, I want to remove a class timetable from a slot lifecycle manager of a room
    ...
    Then a slot lifecycle manager for room 1 should not contain a configuration for class 5

  Scenario: As an admin, I should not be able to remove a class timetable from a non existing slot lifecycle manager
  ...
  Scenario: As an admin, I should not be able to remove a non existing class timetable
    When the class 5 is tried to be removed from room 1
    Then the admin should receive a notification the class 5 for slot lifecycle manager for room 1 does not exist
