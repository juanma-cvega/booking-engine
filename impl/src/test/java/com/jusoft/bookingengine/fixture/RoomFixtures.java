...
public class RoomFixtures {
  ...
  public static final OpenTime OPEN_TIME_MORNING = OpenTime.of(START_TIME_MORNING, END_TIME_MORNING, Clock.systemUTC().getZone(), Clock.systemUTC());
  ...
  public static final OpenTime OPEN_TIME_AFTERNOON = OpenTime.of(START_TIME_AFTERNOON, END_TIME_AFTERNOON, Clock.systemUTC().getZone(), Clock.systemUTC());
  public static final OpenTime OPEN_TIME_NIGHT = OpenTime.of(START_TIME_NIGHT, END_TIME_NIGHT, Clock.systemUTC().getZone(), Clock.systemUTC());
