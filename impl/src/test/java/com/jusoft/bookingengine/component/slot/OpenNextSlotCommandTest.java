...
public class OpenNextSlotCommandTest {
  ...
  public void null_open_date_fails_constructor() {
    assertThatThrownBy(() -> CreateSlotCommand.of(ROOM_ID, BUILDING_ID, CLUB_ID, null, STATE)).isInstanceOf(NullPointerException.class);
  }

  @Test
  public void null_state_fails_constructor() {
    assertThatThrownBy(() -> CreateSlotCommand.of(ROOM_ID, BUILDING_ID, CLUB_ID, OPEN_DATE, null)).isInstanceOf(NullPointerException.class);
  }
}
