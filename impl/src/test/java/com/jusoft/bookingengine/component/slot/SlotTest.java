...
public class SlotTest {
  ...
  public void slot_without_creation_time_fails_creation() {
    assertThatThrownBy(() -> new Slot(SLOT_ID_1, ROOM_ID, null, START_TIME, END_TIME))
      .isInstanceOf(NullPointerException.class);
  }

  @Test
  public void slot_without_start_time_fails_creation() {
    assertThatThrownBy(() -> new Slot(SLOT_ID_1, ROOM_ID, START_TIME, null, END_TIME))
      .isInstanceOf(NullPointerException.class);
  }

  @Test
  public void slot_without_end_time_fails_creation() {
    assertThatThrownBy(() -> new Slot(SLOT_ID_1, ROOM_ID, START_TIME, START_TIME, null))
      .isInstanceOf(NullPointerException.class);
  }
}
