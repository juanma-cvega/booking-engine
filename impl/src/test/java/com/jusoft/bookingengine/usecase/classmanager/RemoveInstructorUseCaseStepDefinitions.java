...
public class RemoveInstructorUseCaseStepDefinitions extends AbstractUseCaseStepDefinitions {
    ...
    @Autowired private RemoveInstructorUseCase removeInstructorUseCase;
    ...
    public void a_notification_of_the_removed_instructor_from_the_class_should_published(
            Long instructorId) {
    ...
    @Then(
            "^the admin should be notified the instructor (\\d+) cannot be removed and leave the list of instructors empty for the class$")
    public void
            the_admin_should_be_notified_the_instructor_cannot_be_removed_and_leave_the_list_of_instructors_empty_for_the_class(
                    Long instructorId) {
