...
public class AddBidderToAuctionUseCaseStepDefinitions extends AbstractUseCaseStepDefinitions {
  ...
  public void the_auction_should_contain_the_user_bid_created_at(Integer userId, String creationTime) {
  ...
  @Then("^the user (.*) should be notified he is not authorized to bid in auctions in the room created$")
  public void the_user_should_be_notified_he_is_not_authorized_to_bid_in_auctions_in_the_room_created (Long userId) {
