...
public class CreateSlotLifeCycleManagerUseCaseStepDefinitions
        extends AbstractUseCaseStepDefinitions {

    @Autowired private SlotLifeCycleManagerComponent slotLifeCycleManagerComponent;

    @Autowired private CreateSlotLifeCycleManagerUseCase createSlotLifeCycleManagerUseCase;
    ...
    public void the_slot_duration_is_minutes(Integer slotDuration) {
        createSlotLifeCycleManagerBuilder.slotsTimetableBuilder.slotDurationInMinutes =
                slotDuration;
    }
    ...
    public void the_slots_are_open(DataTable availableDaysDataTable) {
        List<DayOfWeek> availableDays =
                availableDaysDataTable.row(0).stream()
    ...
    public void the_slots_are_open_from_to(String startOpenTime, String endOpenTime) {
        createSlotLifeCycleManagerBuilder.slotsTimetableBuilder.openTimes.add(
    ...
    public void the_slot_lifecycle_is_created_with_that_configuration() {
        slotLifeCycleManager =
                createSlotLifeCycleManagerUseCase.createSlotLifeCycleManager(
                        createSlotLifeCycleManagerBuilder.build());
    }
    ...
    public void a_slot_lifecycle_manager_for_room_is_created(Long roomId) {
        slotLifeCycleManager =
                createSlotLifeCycleManagerUseCase.createSlotLifeCycleManager(
                        CreateSlotLifeCycleManagerCommand.of(roomId, SLOT_VALIDATION_INFO));
    }
