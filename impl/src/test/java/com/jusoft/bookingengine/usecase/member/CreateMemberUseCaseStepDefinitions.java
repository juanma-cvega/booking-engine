...
public class CreateMemberUseCaseStepDefinitions extends AbstractUseCaseStepDefinitions {
  ...
  @Then("^a notification of a new membership for user (\\d+) has been created should be published$")
  public void a_notification_of_a_new_membership_for_user_has_been_created_should_be_published(Long userId){
