...
public class NewMemberCreatedUseCaseStepDefinitions extends AbstractUseCaseStepDefinitions {
    ...
    @Autowired private NewMemberCreatedUseCase newMemberCreatedUseCase;

    @When(
            "^user (.*) of club (.*) with member ID (.*) is added to the list of members to manage its authorization$")
    public void
            user_of_club_with_member_ID_is_added_to_the_list_of_members_to_manage_its_authorization(
                    Long userId, Long clubId, Long memberId) {
    ...
    public void the_member_should_be_added_to_the_list_of_members_to_manage_its_authorization(
            Long memberId) {
