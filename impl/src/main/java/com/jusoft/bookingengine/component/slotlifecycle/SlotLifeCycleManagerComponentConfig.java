...
public class SlotLifeCycleManagerComponentConfig {
  ...
  public SlotLifeCycleManagerComponent slotLifeCycleManagerComponent() {
    return new SlotLifeCycleManagerComponentImpl(slotLifeCycleManagerRepository(), messagePublisher, slotLifeCycleEventFactory(), clock);
  }

  private SlotLifeCycleManagerRepository slotLifeCycleManagerRepository() {
    return new SlotLifeCycleManagerRepositoryInMemory(new ConcurrentHashMap<>(), new ReentrantLock());
  }
