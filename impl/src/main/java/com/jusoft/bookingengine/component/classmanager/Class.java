...
class Class {
  ...
  Class(long id, long buildingId, String description, List<Long> instructorsId, String classType, List<Long> roomsRegistered) {
  ...
  Class(long id, long buildingId, String description, List<Long> instructorsId, String classType) {
  ...
  private Class copy() {
    return new Class(id, buildingId, description, new ArrayList<>(instructorsId), classType, new ArrayList<>(roomsRegistered));
  }
