...
public class SystemLocalTime implements Comparable<SystemLocalTime>, Temporal {
    ...
    public static SystemLocalTime ofToday(
            LocalTime sourceLocalTime, ZoneId sourceZone, Clock clock) {
        Objects.requireNonNull(sourceLocalTime);
        Objects.requireNonNull(sourceZone);
        Objects.requireNonNull(clock);
        LocalTime systemLocalTime =
                sourceZone.equals(clock.getZone())
                        ? sourceLocalTime
    ...
    /**
     * Returns whether the given {@link SystemLocalTime} is equal. The local time is guaranteed to
