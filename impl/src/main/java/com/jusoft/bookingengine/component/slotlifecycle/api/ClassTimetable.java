...
public class ClassTimetable {
  ...
  public boolean contains(ZonedDateTime startTime, Clock clock) {
    return reservedSlotsOfDays.stream().anyMatch(reservedSlotsOfDay -> reservedSlotsOfDay.contains(startTime, clock));
  }

  public boolean intersectsWith(List<ReservedSlotsOfDay> reservedSlotsOfDays) {
    return this.reservedSlotsOfDays.stream()
      .anyMatch(reservedSlotsOfDay -> reservedSlotsOfDays.stream()
        .anyMatch(configuredReservedSlotsOfDay -> configuredReservedSlotsOfDay.intersectsWith(reservedSlotsOfDay)));
  }
