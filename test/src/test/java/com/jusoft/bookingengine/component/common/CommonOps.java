package com.jusoft.bookingengine.component.common;
...
public class CommonOps {
    ...
    public static final Long END_TIME =
            LocalDateTime.now().plus(1, ChronoUnit.DAYS).toEpochSecond(ZoneOffset.UTC);
    public static final Long ROOM_ID = 1L;
    public static final String CREATE_SLOT_REQUEST =
            "{\"roomId\":"
                    + ROOM_ID
                    + ",\"startTime\":"
                    + START_TIME
